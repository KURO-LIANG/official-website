  ...
  <div id="HomePage">
    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-6 wow zoomIn">
          <img class="img-responsive" src="@/assets/img/2021/01.jpg" alt="茶吧机">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            2021茶吧机
            <small>/ 2021 Tea bar machine</small>
          </h2>
          <p>这是2021茶吧机的产品介绍</p>
          <p>免安装二用型、双水源设计、双出水设计、五级精密过滤、100%真沸腾、无内胆、多档调节、一键智能恒温、升级防烫壶、防爆玻璃壶、触摸操控面板、遥控取水，一键调温</p>
          <h2 class="bigData-device">产品特点说明</h2>
          <p>免安装二用型----共享便捷,可移动制水<br>
            双水源设计------纯水、矿物质水随心切换<br>
            双出水设计------冷水、热水随心切换,想喝就喝<br>
            无内胆----------杜绝千流滚水<br>
            100%真沸腾------烧出健康水,口感更细腻<br>
            多档调节--------饮水温度自动调节，50-100 C,随心所选<br>
            一键智能恒温----自动智能恒温50 C,温度适宜，随时饮用<br>
            遥控取水，一键调温---智能遥控安全省电，不用守在机器旁边，可随心调温</p>
          <a href="#" class="btn btn-lg btn-block btn-info" style="height: 2.5em">联系我们</a>
        </div>
      </div>
    </div>
    <!-- 您身边的IT专家 -->
    ...
    <div id="customer" class="container-fuild">
      <div class="container customer-container">
        <p class="customer-title text-center">合作品牌</p>
...
export default {
  ...
  data() {
    return {
      ...
      customerList: [
        {
          logo: require("@/assets/img/co1.png"),
          title:
        ...
        {
          logo: require("@/assets/img/co2.png"),
          title:
            "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。",
          content:
            "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。"
        ...
        {
          logo: require("@/assets/img/co3.png"),
          title:
            "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。",
          content:
            "您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。您可以双击这里或者点击编辑按钮来修改内容。您还可以添加图标，按钮，图片等常用元素。"
